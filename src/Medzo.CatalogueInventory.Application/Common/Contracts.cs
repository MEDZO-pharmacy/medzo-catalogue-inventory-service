...
public sealed record MedicineRequest(string Name,string GenericName,string Manufacturer,decimal? UnitPrice,DosageForm? DosageForm,Guid? CategoryId,int ReorderThreshold,bool AllowDuplicate=false);
